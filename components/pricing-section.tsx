            ...
            <Card
              ...
              className={`relative bg-white border-2 ${
                plan.popular
                  ...
                  : "border-gray-200"
              } rounded-3xl p-8 shadow-sm hover:shadow-lg transition-shadow h-full flex flex-col`}
            >
              {plan.popular && (
              ...
              <CardContent className="p-0 flex-grow flex flex-col">
                ...
                <Link href="https://app.jamflow.ai">
                  <Button className="w-full h-20 text-2xl bg-blue-600 hover:bg-blue-700 text-white py-4 px-8 rounded-xl font-semibold flex items-center justify-center space-x-2 transition-colors mt-auto">
